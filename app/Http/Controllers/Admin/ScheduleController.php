...
class ScheduleController extends Controller
{
    ...
    public function get($id)
    {
        ...
        <div class="d-flex"   method="POST">
            ...
            <div class="form-group col-lg-2">
                <label>To Time</label>
                <input type="text" class="form-control" value="' . $schedule->to . '"  placeholder="00:00" name="to" >
            </div>
            <div class="form-group col-lg-4 row" style="align-self: end;">
                
                <button type="button" class="ml-1 form-control btn-danger btn col-5" style="margin-top:21px" onclick="removeSchedule(' . "'" . $schedule->id . "'" . ')">
                Remove
            </button>
            </div>
        </div>';
        ...
        if (count($reason->schedules) == 0) {
            $out[] = ' <div class="d-flex "   method="POST">
        ' . csrf_field() . '
        <div class="form-group col-lg-2">
            <label>Price</label>
            <input type="number" class="form-control"
        ...
        <div class="form-group col-lg-2">
            <label>To Time</label>
            <input type="text" class="form-control" placeholder="00:00" name="to" >
        </div>
        <div class="form-group col-lg-4" style="align-self: end;">
            <button  type="button" data-url="/admin/visit-schedule/create/' . $id . '" class="form-control col-5 btn-success btn btn-create  create-schedule" style="margin-top:21px">
                Submit
            </button>
        </div>
    </div>';
