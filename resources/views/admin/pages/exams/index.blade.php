...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">exams list</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center px-3">
                    ...
                    <a class="btn btn-outline-primary btn-sm mx-3" href="{{ route('admin.exams.create') }}"><i
                            class="fa fa-plus"></i> {{ __('admin.add_new') }}</a>
                </div>
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.exams.index') }}" type="post"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.exams.status', $item->id) }}"
                ...
                <div class="cart-footer p-3 d-block d-md-flex justify-content-between align-items-center border-top">
                    {{ $exams->onEachSide(0)->links('admin.partials.pagination') }}

                    <p class="text-center mb-0">
                        {{ __('admin.display') . ' ' . $exams->firstItem() . ' ' . __('admin.to') . ' ' . $exams->lastItem() . ' ' . __('admin.from') . ' ' . $exams->total() . ' ' . __('admin.rows') }}
                    </p>
                </div>
            </div>
            <!-- /.card -->
